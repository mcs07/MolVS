...
ACID_BASE_PAIRS = (
    AcidBasePair('-OSO3H', 'OS(=O)(=O)[O;H]', 'OS(=O)(=O)[O-]'),
    AcidBasePair('–SO3H', '[!O]S(=O)(=O)[O;H]', '[!O]S(=O)(=O)[O-]'),
    AcidBasePair('-OSO2H', 'O[S;D3](=O)[O;H]', 'O[S;D3](=O)[O-]'),
    AcidBasePair('-SO2H', '[!O][S;D3](=O)[O;H]', '[!O][S;D3](=O)[O-]'),
    AcidBasePair('-OPO3H2', 'OP(=O)([O;H])[O;H]', 'OP(=O)([O;H])[O-]'),
    AcidBasePair('-PO3H2', '[!O]P(=O)([O;H])[O;H]', '[!O]P(=O)([O;H])[O-]'),
    AcidBasePair('-CO2H', 'C(=O)[O;H]', 'C(=O)[O-]'),
    AcidBasePair('thiophenol', 'c[S;H]', 'c[S-]'),
    AcidBasePair('(-OPO3H)-', 'OP(=O)([O;H])[O-]', 'OP(=O)([O-])[O-]'),
    AcidBasePair('(-PO3H)-', '[!O]P(=O)([O;H])[O-]', '[!O]P(=O)([O-])[O-]'),
    AcidBasePair('phthalimide', 'O=C2c1ccccc1C(=O)[N;H]2', 'O=C2c1ccccc1C(=O)[N-]2'),
    AcidBasePair('CO3H (peracetyl)', 'C(=O)O[O;H]', 'C(=O)O[O-]'),
    AcidBasePair('alpha-carbon-hydrogen-nitro group', 'O=N(O)[C;H]', 'O=N(O)[C-]'),
    ...
    AcidBasePair('-CONH2', 'C(=O)[NH2]', 'C(=O)[N;H;-]'),
    ...
    AcidBasePair('alpha-carbon-hydrogen-sulfoxide group', 'C[S;D3](=O)C[CH]', 'C[S;D3](=O)C[C-]'),
    AcidBasePair('-NH2', '[CX4][NH2]', '[CX4][N;H;-]'),
    AcidBasePair('benzyl hydrogen', 'c[C;D4;H]', 'c[C;D3;-]'),
    AcidBasePair('sp2-carbon hydrogen', '[CX3;H]', '[CX3;-]'),
    AcidBasePair('sp3-carbon hydrogen', '[CX4;H]', '[CX3-]'),
)
